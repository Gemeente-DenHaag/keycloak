<#macro loginCard provider providerData>
    ...
    <section class="denhaag-card-authentication">
        ...
        <div class="denhaag-card-authentication__cta">
            <a class="denhaag-card-authentication__cta-link denhaag-button denhaag-button--large denhaag-button--primary-action denhaag-button--end-icon" href="${provider.loginUrl}" target="_self" title="${cardLinkButtonAltLabel}">
                ${msg("loginButton")}
